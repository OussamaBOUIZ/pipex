...
#    Updated: 2022/04/24 15:10:56 by obouizga         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FUNCTIONS = check_access_exec.c ft_putchar_fd.c ft_putstr_fd.c ft_split.c ft_strjoin_s.c ft_strlen.c get_paths.c \
