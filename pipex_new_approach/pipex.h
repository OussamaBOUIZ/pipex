...
/*   Updated: 2022/09/16 18:35:57 by obouizga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	first_cmd(int infile, int *fildes, t_b_arg args_b, char **env);
void	last_cmd(int outfile, int *fildes, t_b_arg args_b, char **env);
